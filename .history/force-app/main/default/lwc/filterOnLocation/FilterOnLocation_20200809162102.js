...
export default class FilterOnLocation extends LightningElement {
    @track selectedCategory = 'Select a Category';
    ...
    handleChangeCategory(event) {
     ...
     findtrials(){
        ...
        if(this.selectedCategory!==null || this.selectedCategory !=='Select a Category'){
            console.log("!!!!! in If " + this.selectedCategory);
            getTrials(this.selectedCategory,this.selectedLocation)
            .then(result => {
        ...
        }else if(this.selectedCategory==='Select a Category'){ 
            console.log("!!!!! in Else ");
